# Training Analysis: reward_function_validated_training_tnt_v2

**Date:** 2026-02-21
**Steps completed:** 150
**Total training time:** 3128.5s (52.1 min)
**Wall time:** 3259.0s (54.3 min)
...
| Metric | Value |
|--------|-------|
| Initial BT loss | 0.6861 |
| Final BT loss | 0.3513 |
| Minimum BT loss | 0.301883 (step 143) |
| Maximum BT loss | 0.9110 (step 137) |
| EMA(0.1) best | 0.4556 (step 131) |
| Mean loss | 0.5290 |
| Std loss | 0.1045 |
...
| Metric | Value |
|--------|-------|
| Step 0 (compilation) | 90.0s |
| Mean steady-state (steps 1+) | 20.4s |
| Total training time | 3128.5s (52.1 min) |
